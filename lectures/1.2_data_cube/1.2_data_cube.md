...
- What could a geometry dimension be useful for: storing geometries (e.g. polygons, points) for data extraction,  
- Name the resolutions of the dimensions: x - meter, kilometer; y - meter, kilometer, degrees; time - days, hours, years; bands - micrometers, color
