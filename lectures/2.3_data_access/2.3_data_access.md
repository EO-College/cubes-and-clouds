...
### EXERCISE: 23_data_access_lazy_loading.ipynb
...
Loading: What is the difference between using an openEO remote back-end and openEO Python Client-Side-Processing? Tick what is correct.
...
Filtering: How many time steps are left after filtering temporally 2022-05-10, 2022-06-30?
...
Reducing Bands: How many pixels are left in the datacube after we use `reduce_dimension` over band?

    [[17144085]]

Reducing Dimension: What are the dimension names after running `reduce_spatial`?
