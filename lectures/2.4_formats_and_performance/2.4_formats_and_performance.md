...
| ---------------------------------------------------------------- | ------------------------------------------------------- |
| ![No Chunking](assets/notchunked.png "Data Cube without chunking") | ![Chunking](assets/chunked.png "Data Cube with chunking") |
...
| ------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| ![Spatial Chunking](assets/spatialchunking.png "Data Cube with spatial chunking") | ![Box Chunking](assets/boxchunking.png "Data Cube with box chunking") |
