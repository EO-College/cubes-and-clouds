...
Find the GitHub repository of the... 
...
### The Open Science Journey
Search a license from the [Creative Commons License Chooser](https://creativecommons.org/choose/) that is **free for commercial use** and **Adaptions of the work can be shared, but only under the same or a compatible  license**. Copy the code to its Icon into the text box.
...
Find the Open Data Set "Snow cover in the European Alps: Station observations of snow depth and depth of snowfall" on the catalogue [OpenAIRE](https://explore.openaire.eu/). 

  - Share the link to its DOI (make sure to copy the full link, it starts with https://doi.org/): https://doi.org/10.5281/zenodo.4064128 (all versions), https://doi.org/10.5281/zenodo.5109574 (v1.3)
  - On which repository is the data set registered: Integrated Ocean Observing System (https://ioos.noaa.gov), PANGAEA (https://pangaea.de), ZENODO (https://zenodo.org)
  - Which license is used for the data set. Copy the URL to the license here: https://creativecommons.org/licenses/by/4.0/legalcode
  - Find the open access publication that is connected to the dataset. Copy its DOI here (make sure to copy the full link, it starts with https://doi.org/): https://doi.org/10.5194/tc-2020-289 (preprint), https://doi.org/10.5194/tc-15-1343-2021 (egu)
...
Connect the cloud native data format to it's purpose (and predecessor) (https://www.ogc.org/blog-article/towards-a-cloud-native-geospatial-standards-baseline/)
