...
### Open Data
Open Data – Free primary research data. The free availability and usability of data on the web is often referred to as open data. It is data that has been made available without any restriction for free use, further dissemination and free reuse. Various licences can be used to identify data as open data.
...
### References
- [European Commission (2022). What is open data?. https://data.europa.eu/elearning/en/module1/#/id/co-01](https://data.europa.eu/elearning/en/module1/#/id/co-01)
