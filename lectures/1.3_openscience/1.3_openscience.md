...
-  **Video Idea M.M.:** Go through the open science journey animation. Research Question, **Input Data:** which one chosen, is it open etc, **Code/Analysis:** Open Source in use? Libraries developed open source? Repository, documentation, **Data/Results:** Results openly available, FAIR, Open, **Publication**: Open Access, linked data?, linked code?, dashboard for general public, **Impact:** Is it alot of effort compared to the classical approach: Yes - show download numbers on ZENODO - Is it worth it: Yes.
-  Michael Talks and the different topics are shown next to him in the background, like github, zenodo, doi, 
- F: , A:, I:, R:
- Code
...
- Do the selfassesment on Clirsnow live
