...
To which extent is Google Earth Engine suitable for Open Science. Tick what is correct. *Up for discussion this question, I think it's quite controversial, and for sure has different opinions - but also makes the students think. Maybe we could use a voting question, that is not evaluated*
