...
> [Watch:  STAC - A standardized Metadata Description for EO Data](https://youtu.be/r2qSTdW-_Wk)<br>
...
Is the same number of products findable on all plafforms and in all ways? 
...
Following the exercise with gdalinfo, answer following questions about the raster used there:

What is the NODATA value?

    [[0]]

What are the coordinates of upper left corner in degrees?

    [[72d52'14.58"E, 32d31' 9.58"N]]

What is the EPSSG code of the raster?
