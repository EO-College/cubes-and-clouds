...
- Understand what are Cloud Native formats
...
- Show different cloud native formats and how they are stored
...
Video or animation: Selection what we are interested in for our workflow and then find out which filtering parameters we need

### Dimensions

More information about dimensions of data is in the lecture about [Datacubes](../1.2/) 
TODO based on decision where to put this 
...
TODO: Decide if relevant here: GDALInfo for extracting data
